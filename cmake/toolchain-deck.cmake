# Steam Deck (x86-64 Linux) cross toolchain. Spec: docs/BUILD.md §1, §7, ruling R-3.
...
if(TL_SYSROOT STREQUAL "" OR NOT IS_DIRECTORY "${TL_SYSROOT}")
  message(FATAL_ERROR
    ...
    "Capture one with tools/sysroot.sh <deck-host> and pin its hash in toolchain/VERSIONS "
    "(docs/BUILD.md §9 R-3).")
endif()

set(TL_TRIPLE x86_64-linux-gnu)
