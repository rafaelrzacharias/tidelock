...
//   (docs/CPP-SUBSET.md §1), so RNE uses the 1.5 * 2^23 / 1.5 * 2^52 add-subtract identity,
//   which is exact under the default rounding mode (-ffast-math is banned everywhere, §7).
